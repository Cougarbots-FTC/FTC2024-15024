...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 12285.337847525512; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -11429.77942031238; // x position of the perpendicular encoder (in tick units)
    }
